...
DEFAULT_DIRECTORIES=("../infra_sdk/auth/lib" "../infra_sdk/account/lib" "../infra_sdk/donor/lib")

DEFAULT_DIO_VERSION="^5.3.3"
DEFAULT_SDK_VERSION="^3.5.3"
# DEFAULT_SDK_VERSION=">=3.0.2 <4.0.0"
PUBSPEC_FILES=("../infra_sdk/auth/pubspec.yaml" "../infra_sdk/account/pubspec.yaml" "../infra_sdk/donor/pubspec.yaml")

# Names to be updated in pubspec.yaml
NAMES=("auth" "account" "donor")
