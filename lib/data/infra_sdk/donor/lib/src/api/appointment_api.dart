...
class AppointmentApi {
  ...
  ///
  /// Parameters:
  /// * [donationCenter] - Donation center ID
  ...
  Future<Response<AppointmentInfo>> donorControllerCreateAppointment({ 
    ...
    final _queryParameters = <String, dynamic>{
      r'donationCenter': encodeQueryParameter(_serializers, donationCenter, const FullType(num)),
    };

    dynamic _bodyData;

    try {
      const _type = FullType(CreateAppointmentDTO);
      _bodyData = _serializers.serialize(createAppointmentDTO, specifiedType: _type);
  ...
  Future<Response<BuiltList<AppointmentInfo>>> donorControllerGetCompletedAppointments({ 
    ...
    BuiltList<AppointmentInfo>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(AppointmentInfo)]),
      ) as BuiltList<AppointmentInfo>;
    ...
    return Response<BuiltList<AppointmentInfo>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
