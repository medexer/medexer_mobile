...
import 'package:medexer/core/constants/timers.dart';
...
import 'package:medexer/components/buttons/resend_otp_button.dart';
...
class _ForgotPasswordOtpVerificationScreenState
  ...
  void submitHandler() async {
    ...
    if (isOtpValid.isFalse) {
      ...
      ResetPasswordVerificationDTO formData = ResetPasswordVerificationDTO(
        (instance) => instance
      ...
      ServiceRegistry.authenticationService
          .resetPasswordOtpVerificationService(formData);
    }
  }
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  //   text:
                  //       'Please enter the 4 digit code we sent to ${Get.parameters["email"]} via SMS and WhatsApp.',
                  // ),
